...
6. [契約] セクションで、チェック ボックスをオンにしてサブスクリプション契約、オファーの詳細、プライバシーに関する声明に同意し、 **[購入]**  をクリックします。
...
### <a name="q--what-if-i-want-to-make-changes-to-this-subscription"></a>Q:このサブスクリプションに変更を加える場合、どうすればよいですか?
A: Azure サブスクリプションを変更するには、次のようにします。
