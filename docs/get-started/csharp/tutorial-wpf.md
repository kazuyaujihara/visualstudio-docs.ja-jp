...
1. スタート ウィンドウで、**[新しいプロジェクトの作成]** を選択します。
   ...
   ![[新しいプロジェクトの作成] ウィンドウを表示する](../../get-started/media/vs-2019/start-window-create-new-project.png)
...
1. *Greetings.xaml.cs* を開き、次の行を選択します。 `MessageBox.Show("Hello.")`
