...
@No__t_0 アクティビティを追加するには、 **[ツールボックス]** の **[ステートマシン]** セクションから**StateMachine**アクティビティデザイナーをドラッグし、ワークフローデザイナー画面にドロップします。 この <xref:System.Activities.Statements.StateMachine> アクティビティに子の状態を追加するには、 **[ツールボックス]** から <xref:System.Activities.Statements.State> または <xref:System.Activities.Core.Presentation.FinalState> をドラッグして、 **StateMachine**にドロップします。
