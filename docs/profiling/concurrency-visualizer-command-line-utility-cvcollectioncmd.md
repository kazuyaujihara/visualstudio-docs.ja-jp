...
| MajorVersion | 構成ファイルのメジャー バージョンを指定します。 | [!INCLUDE[vs_dev11_long](../data-tools/includes/vs_dev11_long_md.md)] プロジェクトの場合は、1 を指定する必要があります。 1 が指定されていない場合、ユーティリティは機能しません。 |
