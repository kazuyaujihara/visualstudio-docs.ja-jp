...
| トピック | 説明 |
| - | - |
| [方法: データ サービス クエリを実行します。](/dotnet/framework/data/wcf/how-to-execute-data-service-queries-wcf-data-services) | .NET アプリケーションからデータ サービスを照会する方法を示します。 |
