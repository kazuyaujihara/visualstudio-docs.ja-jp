        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>データ アプリケーションを開発するための Visual Studio と .NET のツールおよび API のサポートについて学習する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Data Lake を使用した U-SQL と .NET でのビッグ データ アプリケーションの開発について学ぶ</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure HDInsight 上の hadoop での Hive クエリの実行について学ぶ</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure ストリーミング分析によるほぼリアルタイムのビッグ データ ソリューションの開発について学ぶ</h3>
                    </div>
                </div>
            </div>
        </div>
