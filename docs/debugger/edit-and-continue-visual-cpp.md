...
> [!IMPORTANT]
> 必要なビルドの設定と機能の互換性に関する他の情報は、次を参照してください。 [ C++エディット コンティニュでは、Visual Studio 2015 Update 3](https://devblogs.microsoft.com/cppblog/c-edit-and-continue-in-visual-studio-2015-update-3/)します。
