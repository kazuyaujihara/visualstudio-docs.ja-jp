---
title: IntelliTrace でスナップショットを表示する
description: IntelliTrace のステップ バックを使用して過去のアプリケーション状態を検証する
ms.date: 09/20/2018
ms.topic: quickstart
helpviewer_keywords:
...
ms.locfileid: "65676431"
---
# <a name="view-snapshots-with-intellitrace-step-back-visual-studio-enterprise-c-visual-basic-c"></a>IntelliTrace のステップ バックでスナップショットを表示する (Visual Studio Enterprise) (C#、Visual Basic、C++)
...
詳細については、[IntelliTrace を使用して以前のアプリの状態を検査する](../debugger/view-historical-application-state.md)方法に関するページを参照してください。
