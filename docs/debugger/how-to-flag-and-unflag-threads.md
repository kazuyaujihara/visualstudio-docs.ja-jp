...
---
# <a name="how-to-flag-and-unflag-threads-c-visual-basic-c"></a>方法: スレッドのフラグの設定とフラグ (C#、Visual Basic、C++)
...
- **並列スタック**ウィンドウで、スレッドまたはスレッドのグループを右クリック**フラグ/\<スレッド >** または**フラグ解除/\<スレッド >**.
