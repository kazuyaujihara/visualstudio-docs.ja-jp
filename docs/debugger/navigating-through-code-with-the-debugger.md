...
デバッガーがアタッチされた状態でアプリを起動するには、 **F5**キーを押し、 **[デバッグ  > ] を選択し**てデバッグを**開始**するか、Visual Studio ツールバーの緑色の矢印を選択します。

 ![DBG&#95;の&#95;基礎&#95;のデバッグ開始](../debugger/media/dbg_basics_start_debugging.png "DBG_Basics_Start_Debugging")
...
![実行してクリック](../debugger/media/dbg-run-to-click.png "[Run To Click (クリックで実行)]")
