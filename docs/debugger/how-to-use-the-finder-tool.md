...
ファインダー ツールを使用することができます、**ウィンドウ検索**ダイアログ ボックスにウィンドウのプロパティまたはメッセージを表示します。 ファインダー ツールは、無効な子ウィンドウを検索し、強調表示するには、どのウィンドウには、子ウィンドウが重複が無効になっているかを識別できます。
 ...
 ![Spy&#43; &#43;ウィンドウの検索 ダイアログ ボックス](../debugger/media/icon_spy--_find.png "Icon_Spy + _Find")  ダイアログ ボックスで検索しますウィンドウ ファインダー ツール

 上記の図は、以下の手順 3 の後に、[ウィンドウ検索] ダイアログ ボックスを示しています。
