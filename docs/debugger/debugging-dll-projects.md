...
C++ プロジェクトの設定の詳細については、次を参照してください。[プロパティ ページ (Visual c)](/cpp/build/reference/property-pages-visual-cpp)します。
...
- [Visual C++ プロジェクト タイプ](../debugger/debugging-preparation-visual-cpp-project-types.md)
