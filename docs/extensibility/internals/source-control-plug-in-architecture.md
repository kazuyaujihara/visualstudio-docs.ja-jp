...
## <a name="components"></a>コンポーネント
 ...
 ![ソース コード管理アーキテクチャ ダイアグラム](../../extensibility/internals/media/vs_sccsdk_plug_in_arch.gif "vs_sccsdk_plug_in_arch")プラグイン VS とソース管理の間の相互作用を示すアーキテクチャ図
