...
- [概要](../../extensibility/internals/configuration-options-overview.md)
 ...
 について説明する方法でプロジェクト[!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)]複数の構成をサポートすることができます。
...
- [展開の管理のためのプロジェクト構成](../../extensibility/internals/project-configuration-for-managing-deployment.md)
 ...
 展開し、2 つの方法を定義します。[!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)]配置をサポートするプロジェクトをサポートします。
