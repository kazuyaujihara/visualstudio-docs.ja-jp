...
- [ツールバーの Guid と Visual Studio の Id](../../extensibility/internals/guids-and-ids-of-visual-studio-toolbars.md)
- [コマンドの Guid と Visual Studio の Id](../../extensibility/internals/guids-and-ids-of-visual-studio-commands.md)
