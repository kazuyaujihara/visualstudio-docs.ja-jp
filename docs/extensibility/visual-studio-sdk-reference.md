...
- <xref:Microsoft.VisualStudio.TextManager.Interop>エディターと言語サービスに使用される従来の相互運用インターフェイス。

- <xref:Microsoft.VisualStudio.Editor>新しいエディターで使用されるクラス。

- <xref:Microsoft.VisualStudio.Language.Intellisense>IntelliSense 用の新しいエディターで使用されるクラス。
...
- <xref:Microsoft.VisualStudio.OLE.Interop>Visual Studio for OLE コンポーネントで使用される相互運用インターフェイス。
...
- <xref:Microsoft.VisualStudio.Shell.Flavor>Visual Studio プロジェクトに使用されるクラス。

- <xref:Microsoft.VisualStudio.Shell.Interop>Visual Studio シェルに使用される相互運用インターフェイス。
...
- <xref:Microsoft.VisualStudio.VCProject>Visual C++ project automation に使用されるクラス。
...
- <xref:VSLangProj>および Visual Basic C#プロジェクトの自動化に使用されます。

- <xref:VSLangProj2>および Visual Basic C#プロジェクトの自動化に使用されます。

- <xref:VSLangProj80>および Visual Basic C#プロジェクトの自動化に使用されます。

- <xref:VslangProj90>および Visual Basic C#プロジェクトの自動化に使用されます。

- <xref:VslangProj100>および Visual Basic C#プロジェクトの自動化に使用されます。

- <xref:VSLangProj110>および Visual Basic C#プロジェクトの自動化に使用されます。

- <xref:VSLangProj140>および Visual Basic C#プロジェクトの自動化に使用されます。

- <xref:Microsoft.VisualStudio.Language.CallHierarchy>および Visual Basic C#オートメーションに使用されます。

- <xref:Microsoft.VisualStudio.Language.NavigateTo.Interfaces>および Visual Basic C#オートメーションに使用されます。
