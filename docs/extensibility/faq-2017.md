...
詳細に[方法。Visual Studio 2017 に移行する機能拡張がプロジェクト](how-to-migrate-extensibility-projects-to-visual-studio-2017.md)します。 さらに、優れたブログ記事が[Visual Studio のセットアップへの変更](https://devblogs.microsoft.com/setup/changes-to-visual-studio-15-setup/)します。
