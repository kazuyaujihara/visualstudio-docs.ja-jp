...
|**すべての送信参照を表示**|選択した名前空間のすべてのファイルについて、以下のものを検索して強調表示します。<br /><br /> -Import ステートメントで`schemaLocation`属性なしで参照されているすべての名前空間。<br />-Import ステートメントと include ステートメントの`schemaLocation`属性で指定されている、選択されていない名前空間内のすべてのファイル。|
...
|**すべての送信参照を表示**|以下のものを検索して強調表示します。<br /><br /> - `schemaLocation`属性を持たないすべての import ステートメントの namespace 属性で指定されたすべての名前空間。<br />-すべての import ステートメントおよび`schemaLocation` include ステートメントの属性で指定されたすべてのファイル。|
