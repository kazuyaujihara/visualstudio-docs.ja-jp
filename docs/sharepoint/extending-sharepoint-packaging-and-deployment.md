...
## <a name="handle-deployment-conflicts"></a>配置競合を処理します。
 ...
 配置競合を確認および解決する独自のコードを使用して、この機能を拡張できます。 詳細については、「[方法 :配置競合を処理](../sharepoint/how-to-handle-deployment-conflicts.md)します。
...
- [方法: SharePoint ソリューションの検証規則を使用したカスタムのフィーチャーとパッケージを作成します。](../sharepoint/how-to-create-custom-feature-and-package-validation-rules-for-sharepoint-solutions.md)
