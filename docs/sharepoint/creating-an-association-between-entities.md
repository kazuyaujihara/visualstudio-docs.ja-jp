...
## <a name="association-methods"></a>関連付けメソッド
 ...
 適切な情報を返すには、各メソッドにコードを追加する必要があります。 他の種類の高度なシナリオをサポートするメソッドを追加することもできます。 これらの各方法の詳細については、[サポートされている操作](http://go.microsoft.com/fwlink/?LinkId=169286)を参照してください。
