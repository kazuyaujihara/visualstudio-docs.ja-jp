...
## <a name="running-the-emulator-from-a-bootable-vhd-is-not-supported"></a>起動可能な VHD からのエミュレーターの実行はサポートされていません
...
## <a name="hyper-v-requires-uncompressed-and-unencrypted-files"></a>Hyper-V に必要な圧縮と暗号化が行われていないファイル
