...
ms.locfileid: "68418590"
---
# <a name="warning-c26812-prefer-enum-class-over-enum-enum3"></a>警告 C26812 は ' enum ' に対して ' enum class ' を優先します (Enum. 3)
列挙型% type% は対象範囲外です。 ' Enum ' に対して ' enum class ' を優先します (Enum. 3)
