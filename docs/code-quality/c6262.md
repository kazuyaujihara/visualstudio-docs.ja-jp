...
ms.locfileid: "71974631"
---
# <a name="c6262"></a>C6262

警告 C6262:関数は、stack の \<constant > バイトを使用します:/analyze: stacksize @ no__t 定数 2 > を超えています。 データの一部をヒープに移動することを考慮してください
...
- [2 つのオブジェクトが等しいかどうかをテストする方法ネイティブ ランタイム チェックを使用する](../debugger/how-to-use-native-run-time-checks.md)