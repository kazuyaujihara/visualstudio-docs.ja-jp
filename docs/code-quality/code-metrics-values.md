...
*匿名メソッド*名前を持たないメソッドだけです。 匿名メソッドは、コード ブロックをデリゲート パラメーターとして渡すを最も頻繁に使用されます。 メソッドまたはアクセサーは、メソッドを宣言するメンバーに関連付けられているなど、メンバーで宣言されている匿名メソッドのコード メトリックスの結果します。 メソッドを呼び出すメンバーに関連付けられていません。
