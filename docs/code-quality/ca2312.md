---
title: 'CA2312: 逆シリアル化の前に NetDataContractSerializer が設定されていることを確認します。'
ms.date: 05/01/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "73441288"
---
# <a name="ca2312-ensure-netdatacontractserializerbinder-is-set-before-deserializing"></a>CA2312: 逆シリアル化の前に NetDataContractSerializer が設定されていることを確認します。
...
<xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> の逆シリアル化メソッドが呼び出されたか、または参照されましたが、<xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> プロパティは null である可能性があります。

このルールは[CA2311](ca2311.md)に似ていますが、分析で <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> が確実に null であるかどうかを判断することはできません。

## <a name="rule-description"></a>規則の説明

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

このルールは、<xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> が null の場合に <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> 逆シリアル化メソッドの呼び出しまたは参照を検索します。 <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> プロパティに関係なく <xref:System.Runtime.Serialization.NetDataContractSerializer> での逆シリアル化を許可しない場合は、このルールと[CA2311](ca2311.md)を無効にし、rule [CA2310](ca2310.md)を有効にします。
...
- 逆シリアル化された型を制限します。 カスタム <xref:System.Runtime.Serialization.SerializationBinder?displayProperty=nameWithType> を実装します。 <xref:System.Runtime.Serialization.NetDataContractSerializer>で逆シリアル化する前に、<xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> プロパティをカスタム <xref:System.Runtime.Serialization.SerializationBinder>のインスタンスに設定します。 オーバーライドされた <xref:System.Runtime.Serialization.SerializationBinder.BindToType%2A> メソッドで、型が予期しない場合は例外をスローして、逆シリアル化を停止します。
  - すべてのコードパスに <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> プロパティが設定されていることを確認します。
...
[CA2310: セキュリティで保護されていないデシリアライザー NetDataContractSerializer を使用しない](ca2310.md)
