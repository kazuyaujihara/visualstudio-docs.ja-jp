...
2.  メニュー バーで、**ビルド**、**ソリューションでコード分析を実行**します。
    ...
    > **C6387 無効なパラメーター値**'pInt' の '0' 可能性があります。 これは、'InCallee' 関数の仕様に準拠していません。
...
### <a name="example-the-inopt-annotation"></a>例:\_で\_opt\_注釈
...
### <a name="example-the-outopt-annotation"></a>例:\_アウト\_opt\_注釈
