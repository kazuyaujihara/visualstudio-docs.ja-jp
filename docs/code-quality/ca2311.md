---
title: 'CA2311: 最初に NetDataContractSerializer を設定しないで逆シリアル化することはできません'
ms.date: 05/01/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "73441315"
---
# <a name="ca2311-do-not-deserialize-without-first-setting-netdatacontractserializerbinder"></a>CA2311: 最初に NetDataContractSerializer を設定しないで逆シリアル化することはできません
...
<xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> プロパティが設定されていない <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> 逆シリアル化メソッドが呼び出されたか、参照されました。

## <a name="rule-description"></a>規則の説明

[!INCLUDE[insecure-deserializers-description](includes/insecure-deserializers-description-md.md)]

このルールは、<xref:System.Runtime.Serialization.NetDataContractSerializer> に <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> が設定されていない場合に、逆シリアル化メソッドの呼び出しまたは参照 <xref:System.Runtime.Serialization.NetDataContractSerializer?displayProperty=nameWithType> を検索します。 <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> プロパティに関係なく <xref:System.Runtime.Serialization.NetDataContractSerializer> での逆シリアル化を許可しない場合は、このルールと[CA2312](ca2312.md)を無効にし、rule [CA2310](ca2310.md)を有効にします。
