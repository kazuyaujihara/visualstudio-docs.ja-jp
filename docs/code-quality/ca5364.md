...
- 非推奨の @no__t 0 の値が参照されました。
- 非推奨の値を表す整数値が @no__t 0 の変数に割り当てられました。
...
[CA5397:非推奨の SslProtocols 値 @ no__t を使用しないでください

[CA5398:SslProtocols の値 @ no__t をハードコーディングしない
