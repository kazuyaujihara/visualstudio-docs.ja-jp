---
title: CA3011:コード DLL インジェクションの脆弱性を確認します。
ms.date: 04/03/2019
ms.topic: reference
author: dotpaul
ms.author: paulming
...
ms.locfileid: "59018617"
---
# <a name="ca3011-review-code-for-dll-injection-vulnerabilities"></a>CA3011:コード DLL インジェクションの脆弱性を確認します。
