...
> [!NOTE]
> このセクションでは、ルール セットは、静的コード分析に関するものです。 Roslyn アナライザー パッケージの使用可能なルール セットについては、[Roslyn アナライザーの使用規則セットを使用する](analyzer-rule-sets.md)を参照してください。
