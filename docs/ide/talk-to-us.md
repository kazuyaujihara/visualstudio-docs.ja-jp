...
ページの下部にある **[このページは役に立ちましたか]** フィードバック ボタンをお使いください。 このボタンは、すべてのドキュメント ページに表示されます。 または、GitHub アカウントを使用して、[docs.microsoft.com](https://docs.microsoft.com/visualstudio/) の任意の Visual Studio ページにフィードバックを追加できます。**[フィードバックの送信]** を選択し、**[このページ]** ボタンを選択してください。同じようにページの一番下にあります。
