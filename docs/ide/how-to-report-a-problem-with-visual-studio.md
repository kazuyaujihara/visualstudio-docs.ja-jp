...
titleSuffix: ''
description: Microsoft が診断と修正を実行できるように Visual Studio の問題を Microsoft に報告する方法について説明します。
ms.date: 03/11/2018
ms.custom: seodec18
ms.topic: conceptual
...
ms.locfileid: "56953658"
---
# <a name="how-to-report-a-problem-with-visual-studio"></a>Visual Studio で問題を報告する方法
