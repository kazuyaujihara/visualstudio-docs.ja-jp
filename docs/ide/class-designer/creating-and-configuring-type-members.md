...
- メニュー バーで **[表示]**  >  **[その他のウィンドウ]**  >  **[クラスの詳細]** の順に選択します。
...
### <a name="create-a-member-using-class-designer"></a>クラス デザイナーを使用してメンバーを作成する
...
### <a name="create-a-member-using-the-class-details-window-toolbar"></a>[クラスの詳細] ウィンドウ ツール バーを使用してメンバーを作成する
...
### <a name="create-a-member-using-the-class-details-window"></a>[クラスの詳細] ウィンドウを使用してメンバーを作成する
...
4. オプションとして、型など、メンバーに関するその他の詳細を指定します。
    ...
    > [!NOTE]
    > キーボード ショートカットを使用してメンバーを作成することもできます。 詳細については、「[クラス ダイアグラムおよびクラスの詳細情報のウィンドウでのキーボードとマウスのショートカット](keyboard-and-mouse-shortcuts-in-the-class-diagram-and-class-details-window.md)」を参照してください。
...
### <a name="editable-and-non-editable-cells"></a>編集できるセルと編集できないセル
...
### <a name="the-class-details-window-and-source-code"></a>[クラスの詳細] ウィンドウとソース コード
...
### <a name="clipboard-functionality-in-the-class-details-window"></a>[クラスの詳細] ウィンドウのクリップボード機能
...
別のプロジェクト ノードの下または参照されるアセンブリ ノードの下に存在する参照される型 (.NET 型など) は、クラス デザイナーのデザイン サーフェイスに読み取り専用として示されます。 開いたプロジェクトに存在するローカル型は読み書き可能であり、その図形は、クラス デザイナーのデザイン サーフェイスで読み書き可能として示されます。
