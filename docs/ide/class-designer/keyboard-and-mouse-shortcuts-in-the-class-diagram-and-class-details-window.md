...
## <a name="use-the-mouse-in-the-class-details-window"></a>[クラスの詳細] ウィンドウでマウスを使用する
...
## <a name="use-the-keyboard-in-class-designer"></a>クラス デザイナーでキーボードを使用する
...
## <a name="use-the-keyboard-in-the-class-details-window"></a>[クラスの詳細] ウィンドウでキーボードを使用する
...
- [Blend でのキーボード ショートカット](../../designers/keyboard-shortcuts-in-blend.md)