...
ms.locfileid: "58323124"
---
# <a name="write-and-manage-code-using-visual-studio"></a>Visual Studio を使用したコードの記述と管理

Visual Studio でコード エディターなどの他のツールを使用して、コードを記述、移動、管理、および強化する方法について説明します。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>プロジェクトまたはソリューションなしで Visual Studio を使用する</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Studio で Git を使用してコードを管理する</h3>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="get-started-with-programming-languages-in-visual-studio"></a>Visual Studio でのプログラミング言語の概要

Visual Studio で最初のアプリを作成します。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Studio での Python の概要</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Visual Basic でのコンソール アプリの作成</h3>
                    </div>
                </div>
            </div>
        </div>
