...
### <a name="set-dialog-box-options-from-the-keyboard"></a>キーボードを使ってダイアログ ボックスのオプションを設定する
...
### <a name="navigate-among-windows-and-files-in-the-ide"></a>IDE 内のウィンドウ間およびファイル間を移動する
