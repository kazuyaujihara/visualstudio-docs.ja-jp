...
.NET Core をターゲットにするプロジェクトの場合、利用できるバージョンが次のように表示されることがあります。

![.NET Core プロジェクトのターゲット フレームワーク バージョン](../media/application-target-framework.png)
