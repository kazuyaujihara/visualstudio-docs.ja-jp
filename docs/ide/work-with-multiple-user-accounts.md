...
アクション内でこれを表示するには、新しい **ASP.NET Core Web アプリケーション** プロジェクトを作成します。 **[新しい ASP.NET Core Web アプリケーション]** ダイアログ ボックスで、 **[Web アプリケーション]** テンプレートを選択してから、 **[認証の変更]** を選択します。
...
**[認証の変更]** ダイアログ ボックスが表示されます。ここでは、ご利用のアプリケーションで使用する認証の種類を選択できます。
