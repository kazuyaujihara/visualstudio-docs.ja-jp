...
ms.locfileid: "66744720"
---
# <a name="customize-the-properties-window"></a>[プロパティ] ウィンドウをカスタマイズします。
...
## <a name="expose-style-features"></a>スタイルの機能を公開します。
...
## <a name="forwarding-display-properties-of-related-elements"></a>転送するには。関連する要素のプロパティを表示します。
...
### <a name="add-property-forwarding"></a>プロパティの転送を追加します。
...
#### <a name="forward-a-property-from-another-element"></a>別の要素からプロパティを転送します。
...
### <a name="define-a-domain-property-that-has-an-external-type"></a>外部の型を持つドメイン プロパティを定義します。
...
### <a name="set-a-property-editor"></a>プロパティ エディターを設定します。
...
など、独自のエディターまたは .NET エディターを指定できます<xref:System.Windows.Forms.Design.FileNameEditor>または<xref:System.Drawing.Design.ImageEditor>します。 たとえば、ユーザーがファイル名を入力できるプロパティを持つ、次の手順を使用します。

#### <a name="define-a-file-name-domain-property"></a>ファイル名のドメイン プロパティを定義します。
...
### <a name="define-your-own-property-editor"></a>独自のプロパティ エディターを定義します。
...
## <a name="provide-a-drop-down-list-of-values"></a>値のドロップダウン リストを提供します。
