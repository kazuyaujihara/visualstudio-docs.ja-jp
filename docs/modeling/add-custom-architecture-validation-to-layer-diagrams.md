...
- グラフ内のノードおよびリンクとして表される Visual Studio ソリューションのレイヤーモデル。
...
- 依存関係図には、少なくとも1つの依存関係リンクがあります。

- コード要素と関連付けられたレイヤーがモデルに存在する。

検証拡張機能をテストするために Visual Studio の実験用インスタンスを初めて起動するときは、これらの特性を持つソリューションを開くか、作成します。
