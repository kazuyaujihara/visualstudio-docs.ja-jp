...
ms.locfileid: "55944937"
---
# <a name="customize-file-storage-and-xml-serialization"></a>ファイル格納処理および XML シリアル化処理をカスタマイズする

ユーザーは、インスタンスを保存するときにまたは*モデル*、Visual Studio でのドメイン固有言語 (DSL) での XML ファイルの作成または更新します。 ファイルは、ストア内のモデルを再作成を再読み込みすることができます。
...
## <a name="understand-monikers"></a>モニカーを理解します。
...
### <a name="avoid-duplicate-monikers"></a>重複するモニカーを回避します。
...
## <a name="customize-the-structure-of-the-xml"></a>XML の構造をカスタマイズします。
