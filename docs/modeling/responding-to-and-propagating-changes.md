...
|境界ルール|境界ルールは、図形の境界を制限するには、具体的には使用されます。|[BoundsRules によってシェイプの位置とサイズが制限される](/visualstudio/modeling/boundsrules-constrain-shape-location-and-size?view=vs-2015)|
