...
ms.locfileid: "62994616"
---
# <a name="define-shapes-and-connectors"></a>シェイプとコネクタを定義します。
...
|シェイプの種類|説明|
|-|-|
|ジオメトリ シェイプ|汎用の四角形または楕円のシェイプ。 シェイプの境界を基準とする特定の位置にテキストやアイコン デコレータを表示できます。 図形ジオメトリ シェイプ内で入れ子にすることもできます。|
...
## <a name="shape-inheritance"></a>シェイプの継承
