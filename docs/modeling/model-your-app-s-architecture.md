...
- データベースとファイルシステムの選択、ネットワークに接続されたアプリケーションと web クライアントの選択など、基本的なテクノロジの選択。
...
## <a name="Patterns"></a>設計パターン
 ...
 よく知られていて、広く適用されている、Observer などの汎用的なデザイン パターンがいくつかあります。 さらに、特定のプロジェクトにのみ適用可能なパターンもあります。 たとえば、web 販売システムでは、顧客の注文に変更が加えられたコードに複数の操作があります。 注文の状態がどの段階においても正確に表示されるように、これらのすべての操作は、データベースを更新するための特定のプロトコルに従う必要があります。
