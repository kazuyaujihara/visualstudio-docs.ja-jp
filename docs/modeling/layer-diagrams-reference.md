...
このトピックでは、依存関係図で使用できる要素について説明します。 作成し依存関係図を描画、表示する方法については詳細な[依存関係図。ガイドライン](../modeling/layer-diagrams-guidelines.md)します。 レイヤー パターンの詳細については、、 [Patterns & Practices サイト](http://go.microsoft.com/fwlink/?LinkId=145794)を参照してください。
