...
マップのツールバーで、[**レイアウト** > **アナライザー**] を選択し、実行するアナライザーを選択します。
...
コード マップのアナライザーは、適用後も引き続き実行されます。 マップを変更すると、適用されたアナライザーが、更新されたマップを自動的に再処理します。 アナライザーの実行を停止するには、マップのツールバーで、[**レイアウト** > **アナライザー**] を選択します。 選んだアナライザーをオフにします。
