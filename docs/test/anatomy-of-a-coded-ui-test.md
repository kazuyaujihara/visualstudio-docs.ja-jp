...
ここでは、[UIMap](/previous-versions/dd580454(v=vs.140)) クラスの機能を拡張するためのカスタム コードを作成できます。 このファイルで作成するコードは、テストが変更されるたびに **[コード化された UI テスト ビルダー]** によって上書きされることはありません。
