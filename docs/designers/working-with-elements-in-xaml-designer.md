...
要素のレイアウトをリセットするには、ドキュメント アウトライン ウィンドウまたはアートボードで要素を右クリックして**レイアウト** > **リセット** *PropertyName*、、 *PropertyName*をリセットするプロパティです (または選択**レイアウト** > **すべて元に戻す**レイアウトのすべてのプロパティをリセットするには要素)。
