...
定義済みの 3D 図形をシーンに追加するには、**[ツールボックス]** で、必要なものを選択してデザイン サーフェスに移動します。 新しい図形はシーンの原点に配置されます。 モデル エディターは 7 種類の図形、**[円すい]**、**[直方体]**、**[円柱]**、**[円盤]**、**[平面]**、**[球]**、**[ティーポット]** を用意しています。
