...
ASP.NET Core Web アプリ</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>DevOps</h3>
                                                    <p>継続的にクラウドでアプリを構築およびリリースし、Azure DevOps Services でアジャイル プラクティスを実装します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>共同作業</h3>
                                                    <p>共同作業リアルタイム環境でコードを共有、編集、およびデバッグします。 </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>コンテナーでの開発</h3>
                                                    <p>コンテナーを使用してモジュラー コンポーネントを分離し、スケーラビリティを向上させます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <a href="/visualstudio/rtvs/">
                                                    <h3>R</h3>
                                                    <p>(Visual Studio 2017 のみ) 通常、統計的な計算とグラフィックスのために使われる、拡張可能なプログラミング言語。</p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                      ...
                                      <div class="card">
                                        <div class="cardImageOuter">
                                          ...
                                          <div class="cardText">
                                            ...
                                            <p>Python と F# を含む、データ サイエンス アプリケーションを作成するための言語とツール (Visual Studio 2017 のみでの R も含まれます)。</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
    ...
    <div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
                <a href="https://devblogs.microsoft.com/visualstudio/"> ブログ </a>
            </li>
            <li>
            ...
            <li>
                <a href="ide/talk-to-us.md"> 問題点の報告 </a>
            </li>
            <li>
                <a href="https://developercommunity.visualstudio.com/spaces/8/index.html"> 開発者コミュニティ </a>
            </li>
        </ul>
    </div>
</div>
