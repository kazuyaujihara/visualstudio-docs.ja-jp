...
9. メニューバーで、[**ビルド** > ] [**officeaddinsetup**] の順に選択します。
   ...
   ビルドが完了したら、次の場所にある**officeaddinsetup**プロジェクトの setup.exe ファイルを見つけることができます。<em>OfficeAddInSetupProjectRoot</em> **\OfficeAddInSetup\Express\SingleImage\DiskImages\DISK1\\**
