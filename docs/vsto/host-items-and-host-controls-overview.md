...
- [XMLNodes コントロール](../vsto/xmlnodes-control.md)
  ...
  ![ホスト項目とホストコントロールの関係](../vsto/media/hostitemscontrols.png "ホスト項目とホストコントロールの関係")
