---
title: Office ソリューションをトラブルシューティングします。
ms.date: 02/02/2017
ms.topic: conceptual
dev_langs:
- VB
...
ms.locfileid: "62978264"
---
# <a name="troubleshoot-office-solutions"></a>Office ソリューションをトラブルシューティングします。
...
- [方法: 無効になっている VSTO アドインを再度有効にします。](../vsto/how-to-re-enable-a-vsto-add-in-that-has-been-disabled.md)
 ...
 ハードまたはソフト無効になっている VSTO アドインを再度有効にする方法について説明します。
