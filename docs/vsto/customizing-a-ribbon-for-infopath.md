...
- [印刷プレビュー] ウィンドウ。
  ...
  **適用対象します。** このトピックの情報は、InfoPath 2010 の VSTO アドイン プロジェクトに適用されます。 詳細については、「[Office アプリケーションおよびプロジェクトの種類で使用できる機能](../vsto/features-available-by-office-application-and-project-type.md)」を参照してください。
