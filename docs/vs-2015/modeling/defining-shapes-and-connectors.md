---
title: 図形とコネクタの定義 |Microsoft Docs
ms.date: 11/15/2016
...
|シェイプの種類|説明|
|----------------|-----------------|
|ジオメトリ シェイプ|汎用の四角形または楕円のシェイプ。 シェイプの境界を基準とする特定の位置にテキストやアイコン デコレータを表示できます。<br /><br /> Geometry 図形内に図形を入れ子にするには、「[図形の入れ子](../modeling/nesting-shapes.md)」を参照してください。|
