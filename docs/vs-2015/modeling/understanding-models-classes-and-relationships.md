---
title: モデル、クラス、およびリレーションシップについてMicrosoft Docs
ms.date: 11/15/2016
...
## <a name="the-dsl-definition"></a>DSL 定義
 @No__t_0 を開くと、[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ウィンドウは次の図のようになります。
 ...
 ![スイムレーンを使用した dsl デザイナー](../modeling/media/dsl-desinger.png "dsl_desinger")
...
## <a name="roles"></a>役割
 ...
 ![ロールとプロパティ。](../modeling/media/propertycode.png "PropertyCode")
...
## <a name="see-also"></a>参照
 [生成された API](../misc/domain-relationships-in-the-generated-api.md) [ドメイン固有言語ツール用語集](https://msdn.microsoft.com/ca5e84cb-a315-465c-be24-76aa3df276aa)のドメインリレーションシップ
