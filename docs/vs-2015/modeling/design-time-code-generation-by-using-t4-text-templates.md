---
title: T4 テキストテンプレートを使用したデザイン時のコード生成 |Microsoft Docs
ms.date: 11/15/2016
...
デザイン時 T4 テキスト テンプレートを使用して、[!INCLUDE[vsprvs](../includes/vsprvs-md.md)] プロジェクトのプログラム コードや他のファイルを生成できます。 通常、テンプレートは、*モデル*のデータに応じて生成されるコードを変更するために記述します。 モデルとは、アプリケーションの要件に関する重要な情報が含まれたファイルまたはデータベースのことです。
