---
title: モデル要素と作業項目のリンク |Microsoft Docs
ms.date: 11/15/2016
...
- [モデル要素と作業項目の間のリンクを削除する](#RemoveLinks)
...
1. **チーム エクスプローラー**で、モデル要素が作業項目にリンクされているチーム プロジェクトに接続していることを確認します。
    ...
    > [!NOTE]
    > リンクされたモデル要素を表示するために使用できるのは、Team Web Access ではなく、チーム エクスプローラーだけです。 ワークスペースが、モデリング図またはモデリング要素を含むモデリング プロジェクトにマップされていることを確認します。 ワークスペースがない場合は、作成する必要があります。 「 [トラブルシューティング](#Troubleshooting) 」および「 [ワークスペースの作成と操作](https://msdn.microsoft.com/library/1d7f6ed8-ec7c-48f8-86da-9aea55a90d5a)」を参照してください。
...
## <a name="see-also"></a>参照
 [UML モデルとダイアグラムの編集](../modeling/edit-uml-models-and-diagrams.md)[アプリのモデルを作成する](../modeling/create-models-for-your-app.md)
