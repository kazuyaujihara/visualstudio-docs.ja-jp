---
title: '方法: 図形またはデコレータのクリックをインターセプトする |Microsoft Docs'
ms.date: 11/15/2016
...
4. 次の部分クラス定義を追加して、shape classs の InitializeShapeFields メソッドをオーバーライドします。
...
## <a name="see-also"></a>参照
 [デコレーターの変更プロパティへの](../modeling/properties-of-decorators.md)[応答と反映](../modeling/responding-to-and-propagating-changes.md)
