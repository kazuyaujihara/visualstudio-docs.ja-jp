---
title: UML クラス図の属性のプロパティ |Microsoft Docs
ms.date: 11/15/2016
...
|   **静的**   |    False     |                                                                                                                    true の場合、この属性の単一の値がこの型のすべてのインスタンスで共有されます。<br /><br /> true の場合、図に表示される属性の名前に下線が付きます。                                                                                                                    |
...
|    **リーフ**    |    False     |                                                                                                                                                                    true の場合、派生型でこの属性の再定義は許可されません。                                                                                                                                                                     |
|  **派生**   |    False     |                                                                                                              true の場合、この属性は他の属性から計算されます。 たとえば、Diagonal は Width と Height から計算されます。 詳細は、 **Description** またはアタッチされたコメントに記述する必要があります。                                                                                                              |
|  **説明**  |   (空)    |                                                                                                                                                                        一般的なメモとして、または属性の値に対する制約を定義するために使用します。                                                                                                                                                                        |
| **要素**  |      1       | **1** : この属性は、指定した型の値を 1 つ持ちます。<br /><br /> **0..1** : この属性には、 `null`値を指定できます。<br /><br /> **\\** \*-この属性の値は、値のコレクションです。<br /><br /> **1.. \\** \*-この属性の値は、少なくとも1つの値を含むコレクションです。<br /><br /> *n* **..** *m* : この属性の値は、 *n* ～ *m* 個の値を含むコレクションです。 |
|  **並べ替え済み**   |    False     |                                                                                                                                                                    true の場合、コレクションは順序付きリストの形式です **複数要素の接続性** が 1 より大きい場合。                                                                                                                                                                     |
|   **一意**   |    False     |                                                                                                                                                                true の場合、コレクション内に重複値は存在しません。 **複数要素の接続性** が 1 より大きい場合。                                                                                                                                                                |

## <a name="see-also"></a>参照
 Uml クラス[図:](../modeling/uml-class-diagrams-reference.md) [uml クラス図の型の参照プロパティ](../modeling/properties-of-types-on-uml-class-diagrams.md)uml クラス図[の操作のプロパティ](../modeling/properties-of-operations-on-uml-class-diagrams.md) [Uml クラス図: ガイドライン](../modeling/uml-class-diagrams-guidelines.md) [uml クラス図: ガイドライン](../modeling/uml-class-diagrams-guidelines.md)
