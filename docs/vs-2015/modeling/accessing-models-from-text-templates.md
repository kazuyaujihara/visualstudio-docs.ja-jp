---
title: テキストテンプレートからのモデルへのアクセス |Microsoft Docs
ms.date: 11/15/2016
...
- テンプレートディレクティブの inherit プロパティを[Modeflag Texttransformation](/previous-versions/bb893209(v=vs.140))に設定します。 これにより、ストアへのアクセスが提供されます。
