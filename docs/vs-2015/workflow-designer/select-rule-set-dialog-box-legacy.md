...
|UI 要素|説明|  
|----------------|-----------------|  
|**新機能。**|開いて、[ルール セット エディター ダイアログ ボックス (レガシ)](../workflow-designer/rule-set-editor-dialog-box-legacy.md)新しいルールの条件を作成します。|  
|**編集.**|開いて、[ルール セット エディター ダイアログ ボックス (レガシ)](../workflow-designer/rule-set-editor-dialog-box-legacy.md)選択したルール条件を編集します。|  
