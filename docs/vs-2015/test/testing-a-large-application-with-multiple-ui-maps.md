...
4. **[追加]** をクリックします。  
    ...
    [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] ウィンドウが最小化されて、**[コード化された UI テスト ビルダー]** ダイアログ ボックスが表示されます。  
