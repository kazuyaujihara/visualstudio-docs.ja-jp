...
|**単体テストを使用して、プロジェクトのコードの割合がテストされているかを識別するためにコード カバレッジを使用します。** コード カバレッジ機能について説明します[!INCLUDE[vsprvsts](../includes/vsprvsts-md.md)]ツールをテストします。|-   [コード カバレッジを使用した、テストされるプロジェクトのコード割合の確認](../test/using-code-coverage-to-determine-how-much-code-is-being-tested.md)|  
|**ロード テスト、単体テストを使用したストレスおよびパフォーマンスの分析を実行します。** ロード テストを作成し、それに単体テストを追加すると、アプリケーションのパフォーマンスおよびストレスの問題を分離するのに役立ちます。 **注:** ロード テストを作成して使用するには、Visual Studio Enterprise が必要です。|-   [ロード テストの作成と編集](https://msdn.microsoft.com/e2985d15-60a7-4177-93b4-f986c2936337)<br />-   [方法: Web パフォーマンス テストおよび単体テストをロード テスト シナリオに追加します。](https://msdn.microsoft.com/03cc073e-9bdf-4530-ae46-504a51884594)<br />-   [方法: ロード テスト シナリオから Web パフォーマンス テストと単体テストを削除します。](https://msdn.microsoft.com/3d6128d2-82b0-42fc-bda2-23a8aa03be07)|  
|**設定して、品質ゲートを適用します。** 品質ゲートをコードの品質を確保しやすく、コードがチェックインされる前にテストの実行を作成できます。|-   [品質ゲートの設定と適用](https://msdn.microsoft.com/library/bdc5666e-6cf0-45b2-a0a1-133c3f61e852)|  
|**単体テストの種類を拡張します。** 機能は、単体テスト フレームワークでできない可能性があるテストを追加できます。 たとえば、テストを通常のユーザーとして実行するかどうかを指定するテスト プロパティを追加できます。 また、フレームワークを拡張して、行の属性をメソッドに追加し、テスト内でその行のデータを使用することもできます。|単体テスト フレームワークを拡張する方法のサンプル コードについては、次の [Microsoft Web サイト](http://go.microsoft.com/fwlink/?LinkId=185591)を参照してください。|  
...
## <a name="related-tasks"></a>関連するタスク  
 ...
 [Microsoft Visual Studio を使用したシステム テストの実行](https://msdn.microsoft.com/library/19fae5c4-5798-4c4c-b531-3e8f901b1130)  
...
### <a name="videos"></a>ビデオ  
 [Channel 9:XAML を使用して構築された Windows ストア アプリの単体テスト](http://go.microsoft.com/fwlink/?LinkId=226285)  
