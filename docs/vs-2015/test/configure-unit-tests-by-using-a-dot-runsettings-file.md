...
## <a name="see-also"></a>参照
 [コードカバレッジ分析のカスタマイズ](../test/customizing-code-coverage-analysis.md) [Visual Studio テストのテスト設定の指定](https://msdn.microsoft.com/library/0c15317e-80c6-4317-aed3-82b8e15e3901)
