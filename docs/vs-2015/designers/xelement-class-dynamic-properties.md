...
ms.locfileid: "68148066"
---
# <a name="xelement-class-dynamic-properties"></a>XElement クラスの動的プロパティ
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このセクションでは、<xref:System.Xml.Linq.XElement?displayProperty=fullName>[t] () クラスの動的プロパティについて説明します。<!-- TODO: review code entity reference <xref:assetId:///t?qualifyHint=False&amp;autoUpgrade=True>  -->) クラス。  
