---
title: シェーダー デザイナーの例 | Microsoft Docs
ms.date: 11/15/2016
...
|[チュートリアル: リアルな 3-D のビリヤード ボールの作成](../designers/walkthrough-creating-a-realistic-3-d-billiard-ball.md)|複数のシェーダー方法とテクスチャ リソースとを組み合わせて、リアルなビリヤード ボール シェーダーを作成する方法を示します。|  
