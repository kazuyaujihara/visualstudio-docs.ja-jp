...
|**素材: 鏡面**|**アクセス**:                              このプロパティをモデル エディターから設定できるようにする場合は **Public**、それ以外の場合は **Private** です。<br /><br /> **値**: 現在のピクセルによる直接光の反射を示す色。|  
|**素材: 反射の度合い**|**アクセス**:                             このプロパティをモデル エディターから設定できるようにする場合は **Public**、それ以外の場合は **Private** です。<br /><br /> **値**: 現在のピクセルに対する反射の光源の輝度を定義する指数。|  
