...
|**テクスチャ座標**|現在のピクセルのテクスチャ座標。<br /><br /> テクスチャ座標は、隣接する頂点間のテクスチャ座標の属性を補間することで求められます。 これはテクスチャ空間における現在のピクセルの位置と見なすことができます。<br /><br /> **出力:**<br /><br /> `Output`: `float2`<br /> テクスチャ座標。|None|
