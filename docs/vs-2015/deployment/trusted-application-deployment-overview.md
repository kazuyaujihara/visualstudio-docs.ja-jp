...
- CertMgr.exe。これは、Internet Explorer のコンポーネントであるため、Windows 98 以降の全バージョンに含まれています。 詳細については、次を参照してください。 [Certmgr.exe (証明書マネージャー ツール)](https://msdn.microsoft.com/library/7e953b43-1374-4bbc-814f-53ca1b6b52bb)します。  
