...
5. **の場所を更新**フィールドに、形式を使用して、完全修飾 URL で更新プログラムの場所を入力 http://Hostname/ApplicationName、または UNC パス形式を使用して\\\Server\ApplicationName、またはをクリックして、 **の参照**更新プログラムの場所を参照するボタンをクリックします。  
