...
プロジェクト フォルダーの階層ノードの名前を変更するには、アンマネージ c++ HierUtil7 プロジェクトのフレームワークを使用します。 詳細については、[HierUtil7 サンプル](http://msdn.microsoft.com/en-us/29c15184-a70c-4813-86c2-fb1d47442d11)を参照してください。  
