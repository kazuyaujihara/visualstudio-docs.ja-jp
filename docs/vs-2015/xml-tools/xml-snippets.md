...
```  
 ...
 詳細については、[方法: XML スニペットを使用して](../xml-tools/how-to-use-xml-snippets.md)を参照してください。  
...
## <a name="schema-generated-xml-snippets"></a>スキーマを生成する XML スニペット  
 ...
 詳細については、[方法: XML スニペットからの XML スキーマを生成](../xml-tools/how-to-generate-an-xml-snippet-from-an-xml-schema.md)を参照してください。  
...
## <a name="create-new-xml-snippets"></a>新しい XML スニペットを作成する  
 ...
 詳細については、[方法: XML スニペットの作成](../xml-tools/how-to-create-xml-snippets.md)を参照してください。  
