---
title: コンテキストメニュー (XML スキーマエクスプローラー) |Microsoft Docs
ms.date: 11/15/2016
...
## <a name="see-also"></a>参照
 [スキーマセットを検索する](../xml-tools/searching-the-schema-set.md) [XML スキーマエクスプローラー](../xml-tools/xml-schema-explorer.md)
