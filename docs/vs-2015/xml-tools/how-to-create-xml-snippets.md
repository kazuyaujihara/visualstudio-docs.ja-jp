...
8. **[保存]** 先 ドロップダウンリストを使用して、ファイルの場所を My Documents\Visual Studio 2005 \ CODE \Code snippets\xml\my XML スニペットフォルダーに変更し、 **[保存]** をクリックします。
...
## <a name="see-also"></a>参照
 [Xml スニペット](../xml-tools/xml-snippets.md)[方法: Xml スニペットを使用](../xml-tools/how-to-use-xml-snippets.md)する[方法: xml スキーマから xml スニペットを生成する](../xml-tools/how-to-generate-an-xml-snippet-from-an-xml-schema.md)
