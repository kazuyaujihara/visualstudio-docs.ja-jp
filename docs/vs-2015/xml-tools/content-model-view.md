...
## <a name="design-surface"></a>デザイン サーフェイス  
 ...
 デザイン サーフェイスが空白の場合、XML エディター、XML スキーマ エクスプローラー、およびウォーターマークが表示されます。 *透かし*XSD デザイナーのすべてのビューへのリンクの一覧を示します。 スキーマ セットには、エラーが発生した場合は、一覧の最後に、次のテキストが表示されます。使用して、エラー一覧を表示し、セット内のエラーを修正します。」  
