...
>  Visual Studio の Express エディションのリリース版の評価期間も 30 日間です。 Visual Studio の Express エディションの評価期間を無期限に延長するには、Visual Studio にサインインするか製品を登録します。
 ...
 アップグレードする前に、「[Visual Studio と MSDN のライセンス ホワイトペーパー](http://www.microsoft.com/download/details.aspx?id=13350)」を Microsoft Web サイトからダウンロードして確認することをお勧めします。 さらに詳しい情報が必要な場合は、[Visual Studio のサポート](http://support.microsoft.com/ph/1117/en-us)にアクセスしてください。
