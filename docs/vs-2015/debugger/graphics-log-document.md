...
|プロパティ|説明|  
|--------------|-----------------|  
|**作成者**|グラフィックス ログのドキュメントを作成したアプリの名前。 たとえば、キャプチャ セッションが [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] (手動キャプチャ) から開始された場合、このプロパティの値は [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] です。|  
