...
ms.locfileid: "51771455"
---
# <a name="stale-code-warning-dialog-box"></a>[古いコードの警告] ダイアログ ボックス
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

このダイアログ ボックスが表示されますが完了したらネイティブへの変更がコードを**エディット コンティニュ**すぐには適用できませんでした。 結果として、現在のスタック フレーム内の一部のネイティブ コードが最新でない (陳腐化している) 場合があります。 詳細については、[方法: 古いコードを操作](http://msdn.microsoft.com/en-us/c7536e95-66a6-44a0-995d-3fe5035250b4)を参照してください。  
