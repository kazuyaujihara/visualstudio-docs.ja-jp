 ...
 **例外が AppDomain またはマネージド/ネイティブ境界を越える場合にブレークします。**  
 ...
 2\) 1 のアプリケーション ドメインで実行されるマネージ コードは、アプリケーション ドメイン 2、マネージ コードを呼び出し、アプリケーション ドメイン 2 のコードが例外をスローします。 参照してください[Programming with Application Domains](http://msdn.microsoft.com/bd36055b-56bd-43eb-b4d8-820c37172131)します。  
...
- 混合モード デバッグ時に、C++ プロジェクトのエディット コンティニュを有効にします。  
  ...
  **デバッグ中に診断ツールを有効にします。**  
  デバッグ中に **[診断ツール]** ウィンドウが表示されます。 詳細については、次を参照してください。[デバッガーに統合されたプロファイリング](http://msdn.microsoft.com/library/a1f40370-7b61-42c2-afc4-0e13eba98859)します。  
