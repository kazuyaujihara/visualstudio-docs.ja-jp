...
2.  例外が検出された場合は、エラーを引き起こしたデータ行を探します。 詳細については、[方法: エラーを含む行を見つけます](http://msdn.microsoft.com/library/1fa907c5-fe66-4f29-a253-2b97b900050c)を参照してください。  
