---
title: WPF アプリケーションで参照テーブルを作成する |Microsoft Docs
ms.date: 11/15/2016
...
1. 次のいずれかの種類のデータソースを関連データと共にプロジェクトに追加します。
    ...
    - オブジェクト。 詳細については、「[方法: オブジェクトのデータに接続する](https://msdn.microsoft.com/library/862fd351-0f4d-4220-9743-6103b87dc24b)」を参照してください。
