...
---
# <a name="how-to-save-and-open-files-with-encoding"></a>方法: 保存し、エンコードでファイルを開く
...
## <a name="see-also"></a>関連項目  
 [エンコード方式および Windows フォームのグローバリゼーション](https://msdn.microsoft.com/library/22e8965d-a712-42b3-8167-3ee346bd70f9)   
