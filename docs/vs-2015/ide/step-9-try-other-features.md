---
title: '手順 9: その他の機能 |Microsoft Docs'
ms.date: 11/15/2016
...
- チュートリアルの前の手順に戻るには、「[手順 8:プレーヤーが勝利したかどうかを確認するメソッドを追加](../ide/step-8-add-a-method-to-verify-whether-the-player-won.md)します。
