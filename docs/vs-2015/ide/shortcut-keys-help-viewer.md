...
|区分|キー操作|アクション|  
|----------|---------------|------------|  
|汎用アプリケーション|Space|編集フィールドを除くすべての場所で、Enter の代わりに使用します。|  
...
|ツール バー|Alt + Home|ヘルプ ビューアーのホーム ページを表示します。|  
|ツール バー|Ctrl + S|目次内の現在のトピックを強調表示します ( **[目次]** タブで)。|  
|ツール バー|Ctrl + D|**[お気に入り]** のタブに現在のトピックを追加します。|  
|ツール バー|Ctrl + F|現在のトピック内のテキストを検索できるように、トピック領域に検索バーを表示します。|  
...
|Tab|フォーカスを切り替えます、**移動しています.** を追加します。|  
