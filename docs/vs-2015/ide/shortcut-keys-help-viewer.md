...
|汎用アプリケーション|F1|現在の UI 要素に関するヘルプを開きます。|
|汎用アプリケーション|F11|全画面表示と通常表示を切り替えます。|
|ToolBar|バックスペース<br /><br /> または<br /><br /> Alt + ← キー|前のページを表示します。|
|ToolBar|Alt + → キー|次のページを表示します。|
|ToolBar|Alt + Home|ヘルプ ビューアーのホーム ページを表示します。|
|ToolBar|Ctrl + S|目次内の現在のトピックを強調表示します ( **[目次]** タブで)。|
|ToolBar|Ctrl + D|**[お気に入り]** のタブに現在のトピックを追加します。|
|ToolBar|Ctrl + F|現在のトピック内のテキストを検索できるように、トピック領域に検索バーを表示します。|
|ToolBar|Ctrl + P|現在のページを印刷します。|
|ToolBar|Ctrl + F2|現在のページの印刷プレビューを表示します。|
|ToolBar|Ctrl + O|**[ビューアーのオプション]** ダイアログ ボックスを表示します。|
|ToolBar|Ctrl + Shift + M|**[コンテンツの管理]** タブを表示します。|
