...
## <a name="see-also"></a>関連項目
 [ソリューションとプロジェクト](../ide/solutions-and-projects-in-visual-studio.md) [NIB 方法: 複数のプロジェクトから成るソリューションを作成する](https://msdn.microsoft.com/02ecd6dd-0114-46fe-b335-ba9c5e3020d6)
