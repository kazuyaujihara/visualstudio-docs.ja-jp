 ...
 **Web サイトおよびプロジェクト用 IIS Express の 64 ビット バージョンを使用する**  
 このオプションをオンにすると、Visual Studio 開発サーバーの代わりに IIS Express が使用されます。 詳細については、「[Introducing IIS Express](http://go.microsoft.com/?linkid=9747914)」 (IIS Express の紹介) と「[IIS Express の概要](http://go.microsoft.com/?linkid=9747915)」を参照してください。 既定では、このオプションは無効です。  
  
 **エラー一覧にエラーがある場合、Web アプリケーションを実行する前に警告を表示する**  
 このボックスをオンにすると、Web アプリケーションがエラーなしでコンパイルできなかった場合、そのアプリケーションを実行しようとすると警告が表示されます。
