...
[!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] には、特定のプログラミング言語に適用するためのテキスト エディター オプションが数多くあります。  
  
## <a name="in-this-section"></a>このセクションの内容  
 [[オプション]、[テキスト エディター]、[基本] (Visual Basic)](../../ide/reference/options-text-editor-basic-visual-basic.md)  
 End 構造、コードの再フォーマット、アウトライン、エラー訂正の提案、およびその他の [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] コード用の設定について説明します。  
 ...
 インデント、改行時の書式、テキストの折り返し、およびその他の C# と J# 用の設定について説明します。  
