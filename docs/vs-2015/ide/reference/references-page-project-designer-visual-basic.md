...
## <a name="see-also"></a>関連項目
 ...
 [方法: 追加またはインポートされた名前空間 (Visual Basic) を削除します。](../../ide/how-to-add-or-remove-imported-namespaces-visual-basic.md)   
 [NIB:Web 参照 ダイアログ ボックスを追加します。](https://msdn.microsoft.com/bdf05776-c591-40af-bfd7-e1e2aa1e87b5)   
 [Imports ステートメント (XML 名前空間)](https://msdn.microsoft.com/library/1f4d50a6-08c7-4c2e-8206-ccae35fcd1b4)
