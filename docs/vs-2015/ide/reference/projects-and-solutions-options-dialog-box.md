 ...
 **ビルド開始時に出力ウィンドウを表示**  
 ソリューション ビルドの開始時に、IDE の出力ウィンドウを自動的に表示します。 詳細については、「[方法 :出力ウィンドウを制御](http://msdn.microsoft.com/library/91aebd15-8854-4a7a-9f7d-57376fb4e858)します。 既定では、このオプションは有効になっています。  
