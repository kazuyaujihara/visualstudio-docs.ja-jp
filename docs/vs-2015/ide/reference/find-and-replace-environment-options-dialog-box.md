 ...
 **情報メッセージを表示**するこのオプションを選択すると、[**常にこのメッセージを表示**する] オプションを持つ [検索と置換] の情報メッセージがすべて表示されます。 たとえば、メッセージ "検索の開始位置に達しました" を表示しない設定の場合、このオプションをオンにすると、[検索と置換] を使用するときにこの情報メッセージが再び表示されるようになります。
 ...
 **警告メッセージを表示**するこのオプションを選択すると、[**常にこのメッセージを表示**する] オプションが指定されているすべての警告を検索して置換します。 たとえば、編集対象のファイルが正しく開かれていない時点で置換を実行しようとしたときに表示される **[すべて置換]** 警告メッセージを表示しない設定の場合、このオプションをオンにすると、[すべて置換] を実行するときに、この警告メッセージが再び表示されるようになります。
