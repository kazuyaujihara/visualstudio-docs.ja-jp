...
### <a name="add-using"></a>using を追加します。
 ...
 ![スマートタグイメージを使用した追加](../ide/media/addusesmart.gif "Add・マート")
 ...
 ![スマートタグの展開された画像を使用して追加](../ide/media/addusesmartexp.gif "Add・ Martexp")
...
## <a name="generate-event-handlers"></a>イベント ハンドラーの生成
 ...
 ![ボタンの自動フック](../ide/media/vxautohookup.gif "vxAutoHookUp フックアップ")
 ...
 ![イベントハンドラーの生成](../ide/media/vxgenerateeventhandler.gif "vxGenerateEventHandler")
