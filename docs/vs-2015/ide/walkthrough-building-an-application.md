...
4. ソリューションをビルドします。
   ...
   **[出力]** ウィンドウには、ビルドの概要情報のみが表示されます。
   ...
   詳細については、「[方法 :コンパイラの警告を抑制する](../ide/how-to-suppress-compiler-warnings.md)します。
...
5. ソリューションをビルドし、**[出力]** のウィンドウの情報をレビューします。
   ...
   詳細については、「[方法 :ビルド ログ ファイルの構成を表示、保存、および](../ide/how-to-view-save-and-configure-build-log-files.md)します。
...
#### <a name="to-specify-a-release-build-for-visual-c"></a>Visual C のリリース ビルドを指定するには\#
