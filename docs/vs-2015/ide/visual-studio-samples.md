...
|領域|説明|
|----------|-----------------|
|[Windows デベロッパー センターのサンプル](http://go.microsoft.com/fwlink/?LinkID=255278)|[!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] のアプリケーションを開発する方法を示します。|
|[.NET Framework のサンプル](http://msdn.microsoft.com/177055f8-4a1f-43e7-aee6-995c196079b1)|C# と Visual Basic の [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] のさまざまな側面を示します。|
|[C# のサンプル](http://code.msdn.microsoft.com/site/search?f%5B0%5D.Type=ProgrammingLanguage&f%5B0%5D.Value=C%23&f%5B0%5D.Text=C%23)|C# のさまざまな機能を使用する方法を示します。|
|[Visual Basic のサンプル](http://code.msdn.microsoft.com/site/search?f%5B0%5D.Type=ProgrammingLanguage&f%5B0%5D.Value=VB&f%5B0%5D.Text=VB.NET)|Visual Basic のさまざまな機能を使用する方法を示します。|
|[F# のサンプル](http://code.msdn.microsoft.com/site/search?f%5B0%5D.Type=ProgrammingLanguage&f%5B0%5D.Value=F%23&f%5B0%5D.Text=F%23)|F# のさまざまな機能を使用する方法を示します。|
