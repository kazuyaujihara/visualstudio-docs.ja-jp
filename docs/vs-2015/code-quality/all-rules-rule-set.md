---
title: ルール セットのすべての規則 |Microsoft Docs
ms.date: 11/15/2016
...
1. [C/C++ コードの警告に対応するコードの分析](../code-quality/code-analysis-for-c-cpp-warnings.md)  
  
2. [マネージド コードの警告に対応するコードの解析](../code-quality/code-analysis-for-managed-code-warnings.md)
