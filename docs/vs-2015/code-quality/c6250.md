...
警告 C6250: 呼び出す\<関数 > VirtualFree メモリを解放する可能性がありますが、いないアドレス記述子 (Vad); MEM_RELEASE フラグなし結果アドレス スペース リーク  
 ...
 詳細については、[VirtualAlloc](http://go.microsoft.com/fwlink/?LinkId=181201)と[VirtualFree](http://go.microsoft.com/fwlink/?LinkId=181202)を参照してください。  
