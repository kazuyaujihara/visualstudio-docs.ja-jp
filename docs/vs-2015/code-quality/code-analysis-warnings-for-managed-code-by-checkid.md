...
|CA2228|[CA 2228:未公開のリソース形式を出荷しません](../code-quality/ca2228-do-not-ship-unreleased-resource-formats.md)|プレリリース バージョンの [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] でビルドされたリソース ファイルは、サポートされるバージョンの [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] で使用できないことがあります。|  
