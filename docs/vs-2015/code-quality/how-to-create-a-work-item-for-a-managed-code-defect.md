---
title: '方法: マネージ コードの障害に対する作業項目の作成 |Microsoft Docs'
ms.date: 11/15/2016
...
ms.locfileid: "68201377"
---
# <a name="how-to-create-a-work-item-for-a-managed-code-defect"></a>方法: マネージド コードの障害に対する作業項目を作成する
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

作業項目トラッキング ログの作業項目内からの機能を使用する[!INCLUDE[vsPreLong](../includes/vsprelong-md.md)]します。 この機能を使用するプロジェクトがチーム プロジェクトの一部をある必要があります[!INCLUDE[esprfound](../includes/esprfound-md.md)]します。  
