---
title: 'CA1815: equals および operator equals を値型でオーバーライドします |Microsoft Docs'
ms.date: 11/15/2016
...
## <a name="cause"></a>原因
 パブリック値型が <xref:System.Object.Equals%2A?displayProperty=fullName> をオーバーライドしていないか、等値演算子 (= =) を実装していません。 このルールは列挙を確認しません。
...
### <a name="description"></a>説明
 次の例では、<xref:System.ValueType.Equals%2A?displayProperty=fullName> をオーバーライドし、等値演算子 (= =、! =) を実装することによって、以前の違反を修正します。
