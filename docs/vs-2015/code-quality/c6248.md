...
```  
 ...
 セキュリティ記述子を作成する方法の完全な例を参照してくださいを参照してください。 [C++ では新しいオブジェクトのセキュリティ記述子を作成する](https://msdn.microsoft.com/library/aa446595.aspx)します。 詳細については、次を参照してください。 [DACL の作成](https://msdn.microsoft.com/library/ms717798.aspx)です。
