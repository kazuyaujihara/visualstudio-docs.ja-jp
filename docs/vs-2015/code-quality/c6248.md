...
```  
 ...
 セキュリティ記述子を作成する方法の完全な例を参照してくださいを参照してください。 [C++ では新しいオブジェクトのセキュリティ記述子を作成する](http://msdn.microsoft.com/library/aa446595.aspx)します。 詳細については、[DACL の作成](http://msdn.microsoft.com/library/ms717798.aspx)を参照してください。
