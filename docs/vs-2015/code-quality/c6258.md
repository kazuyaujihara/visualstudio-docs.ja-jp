...
警告 C6258: TerminateThread を使用してにより適切なスレッドをクリーンアップします。  
 ...
 TerminateThread は、特に極端な場合にのみ使用される危険な関数です。 TerminateThread に関連する問題の詳細についてを呼び出す、MSDN ライブラリでは、このトピックを参照してください。[TerminateThread](http://go.microsoft.com/fwlink/?LinkId=150233)します。  
