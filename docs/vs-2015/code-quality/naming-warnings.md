...
ms.locfileid: "58976743"
---
# <a name="naming-warnings"></a>名前付けに関する警告
[!INCLUDE[vs2017banner](../includes/vs2017banner.md)]

名前付けに関する警告の名前付け規則に準拠しているサポート、[!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]設計ガイドラインです。  
...
|[CA1724:型名が名前空間と一致する必要があります。](../code-quality/ca1724-type-names-should-not-match-namespaces.md)|型の名前は、[!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] クラス ライブラリで定義されている名前空間の名前と一致しないようにする必要があります。 この規則違反は、ライブラリの使いやすさを減らすことができます。|  
