...
|`LangVersion`|省略可能な [String](<!-- TODO: review code entity reference <xref:assetId:///String?qualifyHint=False&amp;autoUpgrade=True>  -->) 型のパラメーターです。<br /><br /> 言語バージョンとして "9" か "10" を指定します。|  
