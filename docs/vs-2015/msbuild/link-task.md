...
- **CLRUnmanagedCodeCheck**  
   ...
   詳細については、「[/CLRUNMANAGEDCODECHECK (SuppressUnmanagedCodeSecurityAttribute の追加)](http://msdn.microsoft.com/library/73abc426-dab0-45e2-be85-0f9a14206cc2)」を参照してください。  
