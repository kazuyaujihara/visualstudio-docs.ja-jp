...
## <a name="extending-classification-types-and-classification-formats"></a>形式の分類の種類と分類の拡張  
...
## <a name="extending-margins-and-scrollbars"></a>拡張の余白とスクロール バー  
