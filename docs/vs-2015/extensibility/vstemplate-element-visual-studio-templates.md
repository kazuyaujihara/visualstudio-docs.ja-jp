...
|`Version`|テンプレートのバージョン番号を指定します。 テンプレートで[!INCLUDE[vs_dev10_long](../includes/vs-dev10-long-md.md)]と[!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)]が、`Version`属性の値`3.0.0`します。|  
