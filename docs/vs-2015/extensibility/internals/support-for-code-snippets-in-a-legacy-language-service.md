...
1.  .Vsct ファイルにコマンドとボタンを追加します。 そのために行うための手順を確認できます[チュートリアル: メニュー コマンドを使った作成の Visual Studio パッケージ テンプレート](http://msdn.microsoft.com/library/1985fa7d-aad4-4866-b356-a125b6a246de)します。  
