---
title: イメージ サービス ツール |Microsoft Docs
ms.date: 11/15/2016
ms.topic: conceptual
...
ms.author: gregvanl
manager: jillfra
ms.openlocfilehash: 2876180c405ebd9eeeb167235ef29b39aa2fad86
ms.sourcegitcommit: 8b538eea125241e9d6d8b7297b72a66faa9a4a47
ms.translationtype: MT
ms.contentlocale: ja-JP
ms.lasthandoff: 01/23/2019
ms.locfileid: "58974001"
---
# <a name="image-service-tools"></a>イメージ サービスのツール
[!INCLUDE[vs2017banner](../../includes/vs2017banner.md)]

VS SDK には、Visual Studio のイメージのサービスを使用して拡張機能のビルダーのヘルプをいくつかのツールが含まれています。  
