...
# [方法: 機能拡張プロジェクトの Visual Studio 2015 への移行](how-to-migrate-extensibility-projects-to-visual-studio-2015.md)
# [よくあるご質問: アドインを VSPackage 拡張に変換する](faq-converting-add-ins-to-vspackage-extensions.md)
...
### [方法: プライベート ギャラリーの Atom フィードを作成する](how-to-create-an-atom-feed-for-a-private-gallery.md)
...
### [エディター ファクトリ](editor-factories.md)
...
### [レガシ API を使用した元に戻すとやり直しの管理](managing-undo-and-redo-by-using-the-legacy-api.md)
#### [方法: 元に戻すの管理を実装する](how-to-implement-undo-management.md)
#### [方法: 元に戻すスタックをクリアする](how-to-clear-the-undo-stack.md)
#### [方法: リンクされた元に戻すの管理を使用する](how-to-use-linked-undo-management.md)
### [方法: 検索と置換のメカニズムを実装する](how-to-implement-the-find-and-replace-mechanism.md)
### [方法: ファイル変更通知を抑制する](how-to-suppress-file-change-notifications.md)
### [フォントと色の使用](using-fonts-and-colors.md)
#### [フォントと色の概要](font-and-color-overview.md)
#### [テキストに色づけするためのフォントと色の情報の取得](getting-font-and-color-information-for-text-colorization.md)
#### [格納されたフォントと色の設定へのアクセス](accessing-stored-font-and-color-settings.md)
#### [カスタム カテゴリと表示項目の実装](implementing-custom-categories-and-display-items.md)
#### [方法: 組み込みのフォントおよび色のスキーマにアクセスする](how-to-access-the-built-in-fonts-and-color-scheme.md)
## [レジストリのツール ウィンドウ](tool-windows-in-the-registry.md)
### [ツール ウィンドウの表示構成](tool-window-display-configuration.md)
...
### [Conditional 属性](vsct-xml-schema-conditional-attributes.md)
...
### [列挙子](enumerators.md)
#### [コマンド コード](command-code-enumerator.md)
#### [メッセージ](message-enumerator.md)
#### [ファイルの状態コード](file-status-code-enumerator.md)
#### [ディレクトリの状態コード](directory-status-code-enumerator.md)
