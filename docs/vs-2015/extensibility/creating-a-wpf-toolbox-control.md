...
3.  .vsix ファイルをネットワークまたは Web サイトにアップロードします。  
     ...
     ファイルをアップロードする場合、 [Visual Studio Marketplace](https://marketplace.visualstudio.com/) Web サイト、他のユーザーが使用できる**ツール/拡張機能と更新**で Visual Studio online のコントロールを検索してインストールします。
