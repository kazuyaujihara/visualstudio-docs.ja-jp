...
> [!NOTE]
>  以下から別の更新に 1 つの場所からアプリケーションをデプロイしで説明する手法を使用することもできます。 詳細については、次を参照してください。[方法: 配置の更新用の別の場所を指定](../deployment/how-to-specify-an-alternate-location-for-deployment-updates.md)します。
