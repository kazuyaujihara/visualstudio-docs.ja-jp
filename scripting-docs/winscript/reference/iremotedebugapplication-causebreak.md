...
## <a name="remarks"></a>Remarks  
 このメソッドを呼び出すと、アプリケーションがすぐに中断されることはありません。 アプリケーションが現在スクリプトコードを実行していない場合は、アプリケーションが実際に中断するまでに長い時間がかかることがあります。  
