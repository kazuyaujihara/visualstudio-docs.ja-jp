---
title: Ijsdebugframe::getname メソッド |Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62558230"
---
# <a name="ijsdebugframegetname-method"></a>IJsDebugFrame::GetName メソッド
スタック フレームのユーザー フレンドリ名を取得します。  
