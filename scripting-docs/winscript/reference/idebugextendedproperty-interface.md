---
title: IDebugExtendedProperty インターフェイス |Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "58156204"
---
# <a name="idebugextendedproperty-interface"></a>IDebugExtendedProperty インターフェイス
拡張`IDebugProperty`インターフェイス。  
  
## <a name="methods-in-vtable-order"></a>Vtable 順序のメソッド  
 継承されたメソッドだけでなく`IDebugProperty`、このインターフェイスは、次のメソッドを公開します。  
  
|メソッド|説明|  
|------------|-----------------|  
|[IDebugExtendedProperty::GetExtendedPropertyInfo](../../winscript/reference/idebugextendedproperty-getextendedpropertyinfo.md)|取得、`ExtendedDebugPropertyInfo`説明します。 `IDebugExtendedProperty``.`|  
