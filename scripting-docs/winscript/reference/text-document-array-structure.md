...
ms.locfileid: "72572976"
---
# <a name="text_document_array-structure"></a>TEXT_DOCUMENT_ARRAY 構造体
[IDebugDocumentText インターフェイス](../../winscript/reference/idebugdocumenttext-interface.md)オブジェクトの配列。 メンバーは CoTaskMemAlloc を使用して割り当てられます。  
