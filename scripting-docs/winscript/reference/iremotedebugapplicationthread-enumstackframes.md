...
#### <a name="parameters"></a>パラメーター  
 `ppedsf`  
 入出力このスレッドに関連付けられているスタックフレームの列挙子。  
...
## <a name="remarks"></a>Remarks  
 このメソッドは、ブレークポイント内から呼び出す必要があります。 スタックフレーム列挙子は、最後にプッシュされたフレームから開始して、スタックの一番上から始まるフレームを返します。  
