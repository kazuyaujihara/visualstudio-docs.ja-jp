---
title: Windows スクリプト インターフェイスの参照 |Microsoft Docs
ms.custom: ''
ms.date: 01/18/2017
ms.reviewer: ''
ms.suite: ''
...
ms.locfileid: "62840097"
---
# <a name="windows-script-interfaces-reference"></a>Windows スクリプト インターフェイスのリファレンス
次のセクションでは、Windows スクリプト インターフェイスについて説明します。  
...
## <a name="in-this-section"></a>このセクションの内容  
 ...
 [デバッグ プロパティ インターフェイス](../../winscript/reference/debug-property-interfaces.md)  
  
 [ディスパッチ拡張インターフェイス](../../winscript/reference/dispatch-extension-interfaces.md)  
