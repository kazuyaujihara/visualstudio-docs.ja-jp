...
[Xamarin.Mac](/xamarin/mac/) により、Cocoa ユーザー インターフェイス フレームワークを使用して Mac アプリをビルドできます。[Mac 版の Xamarin.Forms](/xamarin/xamarin-forms/platform/other/mac) により、コードや UI を他のプラットフォームと共有するアプリをビルドできます。
